...
interface VideoDao {
    @Query(
        ...
        ORDER BY
          ...
          CASE WHEN :sortBy = 'RECORDING_NEWEST' THEN COALESCE(recordingDate, '') END DESC,
          CASE WHEN :sortBy = 'RECORDING_OLDEST' THEN COALESCE(recordingDate, '9999-12-31') END ASC,
          publishedAt DESC
        """
    )
