...
interface VideoDao {
    @Query(
        ...
        ORDER BY
          CASE WHEN :sortBy = 'PUBLICATION_DATE_DESC' THEN publishedAt END DESC,
          CASE WHEN :sortBy = 'PUBLICATION_DATE_ASC' THEN publishedAt END ASC,
          CASE WHEN :sortBy = 'RECORDING_DATE_DESC' THEN recordingDate END DESC,
          CASE WHEN :sortBy = 'RECORDING_DATE_ASC' THEN recordingDate END ASC,
          publishedAt DESC
        """
    )
